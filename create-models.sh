...
$OPEN_SCAD -o $OUTPUTDIR/wrist-rest-right-holes.stl $INPUTDIR/wrist-rest-right-holes.scad &
$OPEN_SCAD -o $OUTPUTDIR/wrist-rest-left-holes.stl $INPUTDIR/wrist-rest-left-holes.scad &
...
$OPEN_SCAD -o $OUTPUTDIR/case-walls-right.stl    $INPUTDIR/case-walls-right.scad &
$OPEN_SCAD -o $OUTPUTDIR/case-walls-left.stl     $INPUTDIR/case-walls-left.scad &
$OPEN_SCAD -o $OUTPUTDIR/switch-plates-right.stl $INPUTDIR/switch-plates-right.scad &
$OPEN_SCAD -o $OUTPUTDIR/switch-plates-left.stl  $INPUTDIR/switch-plates-left.scad &
$OPEN_SCAD -o $OUTPUTDIR/bottom-plate-right.stl  $INPUTDIR/bottom-plate-right.scad &
$OPEN_SCAD -o $OUTPUTDIR/bottom-plate-left.stl   $INPUTDIR/bottom-plate-left.scad &
